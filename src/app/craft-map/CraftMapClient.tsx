...
export default function CraftMapClient({ crafts: STATE_CRAFTS }: { crafts: StateCraft[] }) {
  ...
  const craft = STATE_CRAFTS.find(s => s.state === selected) ?? STATE_CRAFTS[0];
    ...
    <section className="max-w-7xl mx-auto px-5 sm:px-8 pb-16 pt-10 relative">
      ...
      <div className="atlas-layout">
        <div className="atlas-map">
          ...
          <IndiaMap className="w-full" pins={shoppableStates} thread onStateClick={goToState} onStateHover={setSelected} />
      ...
      <div className="mt-10 flex flex-col sm:flex-row justify-between gap-5 sm:items-center">
        <div>
          ...
          <h2 className="section-display text-navy-dark">Find your next story</h2>
